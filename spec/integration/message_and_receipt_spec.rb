  ...
  describe "two equal entities" do
    ...
    describe "message sending" do
      ...
      it "should create proper mails" do
        #Sender Mail
        mail = MessageCenter::Receipt.recipient(@entity1).notification(@message1).first
        assert mail
        if mail
          expect(mail.is_read).to eq(true)
          expect(mail.trashed).to eq(false)
          expect(mail.mailbox_type).to eq("sentbox")
        end
        #Receiver Mail
        mail = MessageCenter::Receipt.recipient(@entity2).notification(@message1).first
        assert mail
        if mail
          expect(mail.is_read).to eq(false)
          expect(mail.trashed).to eq(false)
    ...
    describe "message replying to sender" do
      ...
      it "should create proper mails" do
        #Sender Mail
        mail = MessageCenter::Receipt.recipient(@entity2).notification(@message2).first
        assert mail
        if mail
          expect(mail.is_read).to eq(true)
          expect(mail.trashed).to eq(false)
        ...
        #Receiver Mail
        mail = MessageCenter::Receipt.recipient(@entity1).notification(@message2).first
        assert mail
        if mail
          expect(mail.is_read).to eq(false)
          expect(mail.trashed).to eq(false)
  ...
  describe "three equal entities" do
    ...
    describe "message sending" do
      ...
      it "should create proper mails" do
        ...
        @recipients.each do |receiver|
          mail = MessageCenter::Receipt.recipient(receiver).notification(@message1).first
          assert mail
          if mail
            expect(mail.is_read).to eq(false)
            expect(mail.trashed).to eq(false)
    ...
    describe "message replying to sender" do
      ...
      it "should create proper mails" do
        ...
        #No Receiver, No Mail
        mail = MessageCenter::Receipt.recipient(@entity3).notification(@message2).first
        assert mail.nil?
    ...
    describe "message replying to all" do
      ...
      it "should create proper mails" do
        ...
        @recipients2.each do |receiver|
          mail = MessageCenter::Receipt.recipient(receiver).notification(@message2).first
          assert mail
          if mail
            expect(mail.is_read).to eq(false)
            expect(mail.trashed).to eq(false)
