...
describe MessageCenter::Mailbox do
  ...
  it "should return all mail" do
    ...
    @entity1.mailbox.receipts[0].should==MessageCenter::Receipt.recipient(@entity1).conversation(@conversation)[0]
    @entity1.mailbox.receipts[1].should==MessageCenter::Receipt.recipient(@entity1).conversation(@conversation)[1]
    @entity1.mailbox.receipts[2].should==MessageCenter::Receipt.recipient(@entity1).conversation(@conversation)[2]
    @entity1.mailbox.receipts[3].should==MessageCenter::Receipt.recipient(@entity1).conversation(@conversation)[3]

    assert @entity2.mailbox.receipts
    @entity2.mailbox.receipts.count.should==4
    @entity2.mailbox.receipts[0].should==MessageCenter::Receipt.recipient(@entity2).conversation(@conversation)[0]
    @entity2.mailbox.receipts[1].should==MessageCenter::Receipt.recipient(@entity2).conversation(@conversation)[1]
    @entity2.mailbox.receipts[2].should==MessageCenter::Receipt.recipient(@entity2).conversation(@conversation)[2]
    @entity2.mailbox.receipts[3].should==MessageCenter::Receipt.recipient(@entity2).conversation(@conversation)[3]
  end
  ...
  it "should return inbox" do
    ...
    @entity1.mailbox.receipts.inbox[0].should==MessageCenter::Receipt.recipient(@entity1).inbox.conversation(@conversation)[0]
    @entity1.mailbox.receipts.inbox[1].should==MessageCenter::Receipt.recipient(@entity1).inbox.conversation(@conversation)[1]

    assert @entity2.mailbox.receipts.inbox
    @entity2.mailbox.receipts.inbox.count.should==2
    @entity2.mailbox.receipts.inbox[0].should==MessageCenter::Receipt.recipient(@entity2).inbox.conversation(@conversation)[0]
    @entity2.mailbox.receipts.inbox[1].should==MessageCenter::Receipt.recipient(@entity2).inbox.conversation(@conversation)[1]
  end
  ...
  it "should return trashed mails" do
    ...
    @entity1.mailbox.receipts.trash[0].should==MessageCenter::Receipt.recipient(@entity1).conversation(@conversation)[0]
    @entity1.mailbox.receipts.trash[1].should==MessageCenter::Receipt.recipient(@entity1).conversation(@conversation)[1]
    @entity1.mailbox.receipts.trash[2].should==MessageCenter::Receipt.recipient(@entity1).conversation(@conversation)[2]
    @entity1.mailbox.receipts.trash[3].should==MessageCenter::Receipt.recipient(@entity1).conversation(@conversation)[3]
