...
describe MessageCenter::Notification do
  ...
  it { should ensure_length_of(:body).is_at_most(MessageCenter.body_max_length) }
  ...
  describe "scopes" do
    ...
    describe ".unread" do
      it "finds unread notifications" do
        ...
        MessageCenter::Notification.unread.last.should == unread_notification
      end
    end
